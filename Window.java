...
public class Window extends javax.swing.JFrame implements SerialPortEventListener {
    ...
    private final String PORT_NAME = "COM8";
            ...
            try {
                ...
                if (datos > 0) { //Si el valor leido es mayor a 0...
                    ...
                    if (Mensaje.charAt(Mensaje.length() - 1) == ',') { //Cuando se recibe la coma
                        ...
                        //La parte ENTERA de la temperatura. Se busca el punto, donde quiera que esté
